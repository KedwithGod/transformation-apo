...
class SquareForm extends ViewModelWidget<LandingPageModel> {
  ...
  GlobalKey<FormState> squareFormKey = GlobalKey<FormState>();
          ...
          child:Stack(
            children: [
              ...
              Positioned(
                  left:37 ,
                  top:43,
                  child: GeneralTextDisplay('Offset', Colors.black, 1, 20, FontWeight.w600, 'offset')
              ),  Positioned(
                  left:127 ,
                  top:43,
                  child: GeneralTextDisplay('Length',
                      Color.fromRGBO(230, 69, 0, 1.0), 1, 20, FontWeight.w400, 'lenght')
              ),
               Positioned(
                  left:37,
                  top:93,
                  child: GeneralTextDisplay('X', Color.fromRGBO(0, 0, 255, 1.0), 1, 18, FontWeight.bold, 'x on circle')
              ),  Positioned(
                  left:37 ,
                  top:137,
                  child: GeneralTextDisplay('Y',
                      Color.fromRGBO(217, 0, 27 , 1.0), 1, 18, FontWeight.bold, 'y on circle')
              ),
              Positioned(
                left:73,
                top:93,
                child:GeneralTextField(TextInputType.numberWithOptions(decimal: true,signed: true), offSetX,
                    '', ':','number' ,
                    1, 29, 41),
              ),
              Positioned(
                ...
                top:137
                ,
                child:GeneralTextField(TextInputType.numberWithOptions(decimal: true,signed: true), offSetY,
                    '', ':','number' ,
                    1, 29, 41),
              ), Positioned(
                left:127,
                top:91,
                child:GeneralTextField(TextInputType.numberWithOptions(decimal: true,signed: true), length,
                    '', ':','number' ,
                    1, 29, 70),
              ),
              Positioned(
